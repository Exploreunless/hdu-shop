<template>
  <div class="container container-full">
    <div class="result">
      ...
      <div class="result-bd">
        <div class="result-title">{{ orderInfo.payType ? '支付成功' : '支付失败' }}</div>
        <div class="result-title-sub">{{ orderInfo.payType ? '感谢您的支持' : '再试试支付吧' }}</div>
      </div>
    </div>
    <div class="action">
...
function getDetail() {
  API_ORDER.orderDetail(Number(route.query.orderNumber)).then((res) => {
