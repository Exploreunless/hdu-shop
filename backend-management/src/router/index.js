...
export const asyncRouterMap = [
  {
    ...
    children: [{
      ...
      },
      {
        ...
        component: () => import('@/views/pms/productAttr/list'),
        meta: {title: '商品属性列表'},
        hidden: true
      },
      {
        path: 'addProductAttr',
        name: 'addProductAttr',
        component: () => import('@/views/pms/productAttr/add'),
        meta: {title: '添加商品属性'},
        hidden: true
      },
      {
        ...
        component: () => import('@/views/pms/productAttr/update'),
        meta: {title: '修改商品属性'},
        hidden: true
      },
      {
